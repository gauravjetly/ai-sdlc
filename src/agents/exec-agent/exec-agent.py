...
Self-learning agent that generates Vintiq-branded PowerPoint presentations.
...
class ExecAgent:
    ...
    def __init__(self, enable_mesh: bool = True):
        ...
        self.template_path = Path("/Users/gauravjetly/Downloads/Vintiq PowerPoint Guidelines 2/Vintiq PPT Template and Guidelines 011426.potx")

        # Initialize memory
        self._init_memory()
        self._load_vintiq_brand()
    ...
    def _load_vintiq_brand(self):
        """Load and memorize Vintiq brand guidelines"""
        brand_file = self.memory_dir / "vintiq-brand" / "colors.json"
    ...
    def _add_title_slide(self, prs: Presentation, project: Dict):
        """Add Vintiq-branded title slide"""
        ...
        # Apply Vintiq brand colors
        self._apply_vintiq_styling(title)
    ...
    def _apply_vintiq_styling(self, shape):
        """Apply Vintiq brand styling to shape"""
        if hasattr(shape, 'text_frame'):
            for paragraph in shape.text_frame.paragraphs:
                paragraph.font.name = "Figtree"
                paragraph.font.bold = True
                # Convert hex to RGB
                rgb = self._hex_to_rgb(self.vintiq_brand["colors"]["primary_blue"])
    ...
    def _record_learning(self, project_id: str, pres_type: str, output_path: str):
        ...
        log_entry = {
            ...
            "brand_compliance": "vintiq_official"
        }
